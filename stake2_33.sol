...
contract Staking30days {
    using SafeMath for uint256;

    IERC20 public token;
    uint256 public constant DEFAULT_RATE = 33 * 1e16; // 36% per year as base rate (in 1e18 format)
    uint256 public constant SCALING_FACTOR = 1e18;
    uint256 public constant LOCKUP_PERIOD = 30 days; // 3 months lockup period

    address payable public feeAddress; // Address where fees are sent
    uint256 public constant CLAIM_FEE = 25 * 1e6; // Fee for claiming rewards (10 TRX in sun)
    uint256 public constant UNSTAKE_FEE = 50 * 1e6; // Fee for unstaking tokens (100 TRX in sun)
