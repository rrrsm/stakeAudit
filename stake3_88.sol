...
contract Staking90days {
    using SafeMath for uint256;

    IERC20 public token;
    uint256 public constant DEFAULT_RATE = 88 * 1e16; // 88% per year as base rate (in 1e18 format)
    uint256 public constant SCALING_FACTOR = 1e18;
    uint256 public constant LOCKUP_PERIOD = 90 days; // 3 months lockup period
    ...
    uint256 public constant UNSTAKE_FEE = 25 * 1e6; // Fee for unstaking tokens (25 TRX in sun)
